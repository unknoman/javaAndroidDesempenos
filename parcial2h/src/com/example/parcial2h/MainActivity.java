...
public class MainActivity extends Activity {
    ...
    public boolean validacion(){
     ...
     public void consultar(View xd){
    	BaseDatos bd1 = new BaseDatos(this, "parcial", null, 1);
    	SQLiteDatabase bd = bd1.getWritableDatabase(); // SQLiteDatabase bd1=admin1.getWritableDatabase();
    	String nombre = et2.getText().toString(); // String dni1=et1.getText().toString();
    	Cursor fila=bd.rawQuery("select codigo, nombre, genero from productos where nombre = asd",null);  // Cursor fila1=bd1.rawQuery("select nombre,colegio from votantes where dni="+dni1+"",null);
    ...
    public void altas(View view)
    {
    	...
    	String precio = et4.getText().toString();
     	if(validacion() == false){
    		...
    		BaseDatos bd = new BaseDatos(this, "parcial", null, 1);
    		...
    		bdw.insert("productos", null, registrar);
    		bd.close();
